...
(3, 2, 3, 'Commode de bebe', 30000, 50, 5, 'meuble', '19.25', 'Commode b̩b̩ .jpg');
...
(3, 'tiwa', 'dolvarele', 'F', 'tyyshdsh', 45677899, 'tiwa', 'tiwa@gmail.com', 'Douala', 0);
...
INSERT INTO `commande` (`CmdId`, `CmdDate`, `ClientId`) VALUES
(1, '2021-04-07 07:43:45', 3);
...
(2, 'tiwa', 'dolvarele', 'bonaberie', 678876655, 'tiwa@gmail.com', 'tiwa', 'tiwa shop');
...
INSERT INTO `ligne_commande` (`LigCmd_Id`, `ArtId`, `CmdId`, `QteCmd`, `DateLigCmd`) VALUES
(1, 2, 1, 1, '2021-04-07 07:43:45'),
(2, 1, 1, 1, '2021-04-07 07:54:04'),
(3, 3, 1, 1, '2021-04-07 08:20:39');
